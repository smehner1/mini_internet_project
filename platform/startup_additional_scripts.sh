...
#   
for serv in upload_matrix upload_looking_glass upload_netflows upload_bgpdumps monitor_disk_usage connectivity_matrix_history monitor_group_actvitiy analyze_bgp_policies monitor_disk_usage_alert delete_old_nf_and_bgp connectivity_matrix_history; do 
    if [ $KILL == 1 ]; then
